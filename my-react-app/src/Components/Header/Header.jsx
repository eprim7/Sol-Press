  ...
  return (
    <header className={styles.header}>
      <div className={styles.div}>
        ...
        <nav className={styles.nav}><Link to="/menu" className={styles.nav}>Menu</Link></nav>
        <nav className={styles.nav}><Link to="/about" className={styles.nav}>About</Link></nav>
        <nav className={styles.nav}><Link to="/reviews" className={styles.nav}>Reviews</Link></nav>
        <nav className={styles.nav}><Link to="/contact" className={styles.nav}>Contact</Link></nav>
      </div>
    </header>
  );
}
